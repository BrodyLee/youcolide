...
(function($, window, undefined) {
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				{text: 'One day', dateStart: function() { return moment() }, dateEnd: function() { return moment() } },
				{text: 'First week', dateStart: function() { return moment().subtract('days', 1) }, dateEnd: function() { return moment().subtract('days', 1) } },
				{text: 'Last week', dateStart: function() { return moment().subtract('days', 6) }, dateEnd: function() { return moment() } },
				...
				{text: 'First month', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
				...
				{text: 'Lifetime', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } }
			],
			initialText: 'Period', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'Apply', // use '' to get rid of the button
			clearButtonText: 'Clear', // use '' to get rid of the button
			cancelButtonText: null, // use '' to get rid of the button
			...
			applyOnMenuSelect: false, // whether to auto apply menu selections
		...
		function init() {
			...
			buttonPanel = buildButtonPanel(classname, options, {
				...
				onClear: function (event) {
                    $(".ui-menu-item").css('opacity', '1');
       $(".ui-menu-item").removeClass("act-li");  
       $(".ui-menu-item").removeClass("dis-li");  
//					close(event);
					clearRange(event);
				},
		...
		function render() {
            ...
            $('#dateId').append($mask).append($container);
		}
		...
		function usePreset(event) {
            current = this;
      $('.ui-menu-item').css('opacity', '0.5');
            $('.ui-menu-item').removeClass("act-li");
            $('.ui-menu-item').removeClass("dis-li");
        $('.ui-menu-item').addClass("dis-li");
      $(current).addClass("act-li");
